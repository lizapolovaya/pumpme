                        ...
                        <div className="space-y-3">
                            ...
                            >
                                ...
                                <button
                                    ...
                                    className="flex h-6 w-6 items-center justify-center rounded-full text-on-surface-variant transition-colors hover:bg-white/5 hover:text-on-surface focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primary-dim"
                                ...
                                {showOneRmInfoTooltip ? (
                                    <div
                                        className="pointer-events-none absolute top-full left-0 z-30 mt-3 w-72 max-w-xs rounded-xl border border-outline-variant/20 bg-surface-container-high px-3 py-2 text-left shadow-xl shadow-black/20"
