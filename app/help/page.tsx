            ...
            <main className="mx-auto max-w-3xl space-y-6 px-6 pt-24 pb-24">
                <section className="rounded-[2rem] bg-surface-container-low p-8">
                    ...
                    <div className="mt-6 space-y-5 text-sm leading-6 text-on-surface-variant">
                        ...
                        <p>Profile settings save locally through the app APIs. If a save fails, the page shows the backend error inline so you can correct the input.</p>
                        <p>The demo logout only exits the local browser session. It does not remove the seeded workout data from the local database.</p>
                    </div>
